...
\end{itemize}
& tief & hoch\\\hline
\A{2000}&\multicolumn{4}{p{10cm}|}{Die Ferienplanung kann dann erstellt werden, wenn die gemäss in der Beschreibung beschriebenen, zwingenden Felder ausgefüllt wurden.}\\\hline
